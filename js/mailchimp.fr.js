...
jQuery.extend(jQuery.validator.messages, {
  required: "Ce champ est requis.",//"This field is required. Ce champ est requis.",
  email: "Veuillez entrer une adresse courriel valide."//"Please enter a valid email address. Veuillez entrer une adresse courriel valide."
});
...
jQuery(function ($) {
  function mce_localize(string) {
    ...
    // example@example.com is already subscribed to list Open North Newsletter. <a href="http://opennorth.us2.list-manage.com/subscribe/send-email?u=a602fac79ef3dc584bf1a2743&amp;id=49afb9ad21&amp;e=amFtZXNAb3Blbm5vcnRoLmNh">Click here to update your profile.</a>
      ...
      return string.replace('is already subscribed to list Open North Newsletter', 'est déjà inscrit à ce bulletin').replace('Click here to update your profile.', 'Cliquez pour mettre à jour votre profil.');
    }
  }
